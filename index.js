        ...
        */
        PhotonPeer.prototype.connect = function () {
            ...
            this._socket.on('connect', function(socket){
                // Set event handlers.
                socket.on('open', function (ev) {
                    this.logger.debug("onopen");
                });
                socket.on('message', function (ev) {
                    var message = _this._decode(ev.utf8Data);
                ...
                _this._connection = socket;
            });

            this._socket.on('connectFailed', function(err){
                _this._onConnectFailed(err);
            });

            if (this.subprotocol == ""){
                this._socket.connect(this.url);
            } else {
                this._socket.connect(this.subprotocol);
            }
    ...
    (function (LoadBalancing) {
        ...
        var RoomInfo = (function () {
            ...
            */
            ...
            RoomInfo.prototype._updateFromProps = function (props, customProps) {
                if (customProps === void 0) { customProps = null; }
                if (props) {
        ...
        var LoadBalancingClient = (function () {
            ...
            */
            ...
            LoadBalancingClient.prototype.addActor = function (a) { this.actors[a.actorNr] = a; this.actorsArray.push(a); this.currentRoom.playerCount = this.actorsArray.length; };
            ...
            LoadBalancingClient.prototype.clearActors = function () { this.actors = {}; this.actorsArray = []; this.currentRoom.playerCount = 0; };
